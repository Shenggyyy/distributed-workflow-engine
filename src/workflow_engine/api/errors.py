...
from workflow_engine.repositories.completions import StoredCompletionError
from workflow_engine.repositories.leases import StoredLeaseError
...
def install_error_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(StoredCompletionError)
    @app.exception_handler(StoredLeaseError)
